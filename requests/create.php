...
<html lang="en">
    <head>
        ...
        <title>Food4U | Events Create</title>
    ...
    <body>
        ...
        <?php include(ROOT_PATH . "/app/controllers/requestCreate.php") ?>
        ...
        <div class="nav-main">
            ...
            <main>
                ...
                <form action="<?php echo BASE_URL . '/requests/create.php' ?>" method="post" enctype="multipart/form-data">
                    <article>
                        ...
                        <section class="section-input">
                            <div>
                                ...
                                <div class="partner-container">
                                    <input type="checkbox" name="partnership" value="true">
                ...
                <?php endif; ?>
                    ...
                    <button type="submit" name="request">CREATE</button>
                </form>
            </main>
        </div>
